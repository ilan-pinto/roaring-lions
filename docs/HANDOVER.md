...
|---|---|---|---|---|---|
| A (packages/app) | S2b #171 renderer half (Phase 2 Tasks 15–16) | `feat/shell-phase-2-render` · `.claude/worktrees/ep-s2r` | plan `docs/superpowers/plans/2026-09-18-shell-upgrade-phase-2.md` Tasks 15–16 | 20 Sep: A1.2 landed, so the range rings and the minimap on the lit ground start now, subagent-driven; expect a bless on `vehicle`? no — Task 16 selects nothing in a gated scenario; verify | then S3e #178 execution in Stage 2 (plan landed #198) |
| B (render · art · data) | G-E2 #174 + G-E4 #176 (one plan, behind the LedgerStore ruling) · A1.3 #177 vehicle weight | `feat/gamification-e2e4` · `.claude/worktrees/ep-e2` · `feat/art-vehicle-weight` · `.claude/worktrees/ep-a13` | briefs in the session scratchpad → plans → SDD | 20 Sep: both landed packages (E3 #208, blast #209) closed; E2/E4 and A1.3 in research | then A3.1 #179 bible + Meshy batches (G1 first), G-E5 #181 after G7 |
