...
describe('Wadi Halam V fence — the passive control is unchanged', () => {
  ...
  // busy machine, not a hang; `passiveResult` stops at its own tick ceiling.
  it('still DEFEATs with no orders at all, and raze_depot is still the failure', { timeout: 30_000 }, () => {
