"""Preview the attack drone on the locked rig, over ground, in palette colour.

    /Applications/Blender.app/Contents/MacOS/Blender --background \
        --python tools/drones/preview_attack_drone.py

Writes art/showcase/attack_drone_mock_{nose,side,tail}.png. Does not save the
.blend and does not touch assets/sprites/ -- for looking at only, same
contract as tools/vehicles/preview_technical.py.
"""
import math
import os
import sys
...
OUT = os.path.abspath("art/showcase/attack_drone_mock.png")

#: rl_role -> hex, matching render_attack_drone.py's ROLE_PALETTE exactly, so
#: what is approved here is what ships.
PAL = {
    "hull": "#8F9464",     # olive.1 -- fuselage
    "plate": "#E6D8BE",    # limestone.1 -- pod and fins
    "metal": "#8E9491",    # gunmetal.2 -- seeker tip
    "recess": "#14150F",   # shadow.1 -- collar seam
}
GROUND = "#D9C7A7"          # limestone.2 -- a mid terrain tone
...
def main():
    ...
    written = []
    for label, frame in (("f00", 0), ("f04", 4), ("nose", 6), ("side", 10), ("tail", 14)):
