...
// RendererOptions, TerrainTones and TerrainScatter live in api.ts now — the
// contract both backends are constructed with belongs beside the interface,
// not inside the Pixi implementation. Re-exported here so every existing
